    ...
    public function status()
    {
        ...
        $data['pemenang'] = $this->pemenang
            ->select('
                transaksi_pemenang.*, 
                barang.nama_barang, 
                transaksi_pembayaran.status AS status,
            ...
            ->join('transaksi_pembayaran','transaksi_pembayaran.id_pemenang = transaksi_pemenang.id_pemenang','left')
            ->where('transaksi_pemenang.id_user', $id_user)
            ->orderBy('transaksi_pemenang.id_pemenang','DESC')
            ->findAll();
